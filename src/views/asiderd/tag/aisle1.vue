  ...
  <div>
    ...
    >
      ...
      <!-- <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="直线运动" name="first">用户管理</el-tab-pane>
        <el-tab-pane label="正弦运动" name="second">配置管理</el-tab-pane>
      </el-tabs> -->
      ...
      <div class="add">
        ...
        <div class="tab-content">
          <div v-show="cur==0">
            <test1></test1>
            <!-- <p>模型参数</p>
      <el-form-item label="初始伪距" prop="name">
        <el-input v-model="ruleForm.name" size="mini"></el-input>
      </el-form-item>
      <el-form-item label="初始速度" prop="name">
        <el-input v-model="ruleForm.name" size="mini"></el-input>
      </el-form-item>
      <el-form-item label="初始加速度" prop="name">
        <el-input v-model="ruleForm.name" size="mini"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="onSubmit" size="mini">提交</el-button>
